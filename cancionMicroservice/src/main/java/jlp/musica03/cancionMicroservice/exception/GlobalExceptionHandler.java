...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> manejarCancionNoEncontrada(CancionNoEncontradaException ex,
                                                                     HttpServletRequest request) {
        log.warn("Canción no encontrada. Ruta: {} - Mensaje: {}", request.getRequestURI(), ex.getMessage());
