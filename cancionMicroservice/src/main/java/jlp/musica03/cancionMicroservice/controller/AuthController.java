...
import jlp.musica03.cancionMicroservice.dto.LoginRequest;
import jlp.musica03.cancionMicroservice.dto.LoginResponse;
import jlp.musica03.cancionMicroservice.service.AuthService;
...
public class AuthController {
    ...
    public ResponseEntity<?> login(@RequestBody LoginRequest request) {
        System.out.println("Ejecutando AuthController.login()");
