...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(OperarioNoEncontradoException.class)
    public ResponseEntity<ErrorResponse> manejarGeneroNoEncontrado(OperarioNoEncontradoException ex,
                                                                   HttpServletRequest request) {
        log.warn("Género no encontrado. Ruta: {} - Mensaje: {}", request.getRequestURI(), ex.getMessage());
